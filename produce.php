...
return [
    ...
    'MAIN_SERVER'=>[
        ...
        'SETTING'=>[ //https://wiki.swoole.com/wiki/page/274.html
            'worker_num'=>1000,//运行的  worker进程数量    业务代码是全异步非阻塞的，这里设置为CPU核数的1-4倍最合理
            'max_request'=>10000,// worker 完成该数量的请求后将退出，防止内存溢出
            'task_worker_num'=>1000,//运行的 task_worker 进程数量
    ...
    'REDIS'=>[
        'host'          => 'r-2zeyu6aw5wozyw1ot2.redis.rds.aliyuncs.com',
        #'host'          => '172.17.212.131',
        'port'          => '6379',
