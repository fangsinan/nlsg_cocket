...
class EasySwooleEvent implements Event
{
    ...
    public static function mainServerCreate(EventRegister $register)
    {
        ...
        if ($ListPort['eth0'] == '172.17.225.216' || $ListPort['eth0'] == '172.17.225.223') {//172.17.225.216
        ...
        if($ListPort['eth0']=='172.17.225.217' || $ListPort['eth0']=='172.17.225.223' ){ //172.17.225.217
