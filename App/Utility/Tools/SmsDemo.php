...
require_once(EASYSWOOLE_ROOT . '/vendor/SendSms/api_sdk/vendor/autoload.php');
...
class SmsDemo
{
    ...
    static $_SendSmsRequest = null;
    static $_SendBatchSmsRequest = null;
    ...
    static public function getInstance($type,&$_this) {
        if ($_this == null) {
            switch($type){
                case 1:
                    $_this = new SendSmsRequest();
                    break;
                case 2:
                    $_this = new SendBatchSmsRequest();
                    break;
            }
        }
        return $_this;
     ...
     */
    //https://usercenter.console.aliyun.com/?spm=5176.sms-account.0.0.31321cbedbHa9C#/manage/ak
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIoc6MEUkawJe1"; // AccessKeyId

        $accessKeySecret = "1ciSZf83nwm6GrrlP5xd3qWL08FPDG"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phone,$template,$param,$name="慧宇教育") {

        // 初始化SendSmsRequest实例用于设置发送短信的参数
        $request = self::getInstance(1,static::$_SendSmsRequest);
...
//        $request->setSmsUpExtendCode("1234567");
    ...
    public static function sendBatchSms() {
        ...
        // 初始化SendSmsRequest实例用于设置发送短信的参数
        $request = self::getInstance(2,static::$_SendBatchSmsRequest);
