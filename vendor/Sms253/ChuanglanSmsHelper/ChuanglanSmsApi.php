...
class ChuanglanSmsApi {
	...
	const API_ACCOUNT= 'M4820476'; // 创蓝API账号
	
	const API_PASSWORD= 'qyiePVQk1';// 创蓝API密码
	 ...
	 * 此接口可以提交不超过1000个手机号码，每个号码用英文逗号间隔
	 */
	public function sendSMS( $mobile, $msg,$sendtime=0) {
		...
		if(!empty($sendtime)){
			$postArr['sendtime']=$sendtime; //格式为yyyyMMddHHmm 201704101400
		}
	 ...
	 *
	 * @param string $msg 			短信内容
	 * @param string $params 	最多不能超过1000个参数组  15800000000,1234;13800000000,4321
	 * msg 【253云通讯】您的验证码是：{$var}
	 */
	public function sendVariableSMS( $params,$msg, $sendtime=0) {
